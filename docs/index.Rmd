...
We can manipulate the dataframe using tidyverse to examine the proportion of words that represent positive versus negative sentiment by each year. In the code below, we manipulate the `tweets_analysis` df to calculate percent positive, percent negative, and the difference (positive - negative) for the *sentiment score* for each year.
